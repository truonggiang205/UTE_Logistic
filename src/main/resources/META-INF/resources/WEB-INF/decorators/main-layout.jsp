...
<body>
	<header class="ghtk-header">
		<div class="header-container">
			<div class="logo">
				<a href="/"> <img src="<c:url value='/images/logo_nghv1.png'/>"
					alt="NGHV Logo">
				</a>
			</div>
        ...
        <div class="footer-body">
            ...
            <div class="footer-col app-download">
                ...
                <div class="download-wrapper">
                    <div class="qr-box">
                        <img src="<c:url value='/images/qr-code.png'/>" alt="QR Code">
                    </div>
                    <div class="store-buttons">
                        <a href="#"><img src="<c:url value='/images/app-store.png'/>" alt="App Store"></a>
                        <a href="#"><img src="<c:url value='/images/google-play.png'/>" alt="Google Play"></a>
                    </div>
                </div>
            </div>
        </div>
