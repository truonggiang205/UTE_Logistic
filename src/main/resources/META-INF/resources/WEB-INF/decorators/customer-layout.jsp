	...
	<header
		...
		<div class="flex items-center h-full">
			<a href="/customer/overview"
				...
				src="<c:url value='/images/logo_nghv1.png'/>" alt="NGHV"
				class="h-20 w-auto">
			</a>
				...
				<div id="chatDropdownMenu"
					...
					<div
						...
						<span class="font-black text-sm uppercase text-gray-700">Thông
							báo & Chat</span> <span
							class="text-[10px] bg-nghv-green text-white px-2 py-0.5 rounded-full">3
							Mới</span>
					</div>
					<div class="max-h-[400px] overflow-y-auto custom-scrollbar">
						<c:forEach var="i" begin="1" end="4">
							<div
								...
								<div>
									<p class="text-xs font-bold text-gray-800">Cập nhật đơn
										hàng #NGHV123</p>
									<p class="text-[11px] text-gray-500 line-clamp-1">Đơn hàng
										của bạn đã được điều phối...</p>
								</div>
							</div>
						</c:forEach>
					</div>
		...
		<aside id="rightSidebar"
           ...
           transition-all duration-300 hover:scale-105">
			...
			<div class="flex flex-col space-y-6">
              ...
              hover:bg-gray-50
              transition-all duration-300 hover:scale-105
              ${currentPage == 'warehouse' ? 'active' : ''}">
					<i class="fa-solid fa-boxes-stacked text-3xl w-8 text-center"></i>
					<span class="sidebar-text text-lg font-bold tracking-wide hidden">Kho
						bãi</span>
