...
<script>
  var API =
    "${pageContext.request.contextPath}/api/manager/notifications/recent";
  ...
  function getTargetBadge(target) {
    var badges = {
      ALL: '<span class="badge badge-success">Tất cả</span>',
    ...
    return (
      badges[target] || '<span class="badge badge-light">' + target + "</span>"
    );
  }
