  ...
  <body id="page-top">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p class="mb-0 opacity-75">
                    Khách hàng mang hàng đến bưu cục gửi
                  </p>
                </div>
                <div>
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="form-card">
                    ...
                    <div class="form-card-body">
                      ...
                      <!-- Gợi ý địa chỉ cũ -->
                      <div
                        id="senderAddressSuggestions"
                        class="mb-3"
                        style="display: none">
                        <label class="text-muted"
                          ><i class="fas fa-history"></i> Địa chỉ đã lưu:</label
                        >
                    ...
                    <div class="form-card-body">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <label
                              ><i class="fas fa-camera text-primary"></i> Ảnh
                              hàng hóa</label
                            >
                            <div class="custom-file mb-2">
                              ...
                              <label class="custom-file-label" for="parcelImage"
                                >Chọn ảnh hàng hóa (tối đa 1 ảnh)...</label
                              >
                            </div>
                            <small class="text-muted"
                              >Hỗ trợ: JPG, PNG, GIF. Tối đa 5MB.</small
                            >
                            <div
                    ...
                    <div class="form-card-body">
                      <div id="routeList">
                        <p class="text-muted text-center">
                          <i class="fas fa-spinner fa-spin"></i> Đang tải danh
                          sách tuyến đường...
                        </p>
                      </div>
                      <input
                  ...
                  <div class="form-card">
                    ...
                    <div class="form-card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <label class="font-weight-bold mb-3">
                            <i class="fas fa-user-tag text-primary"></i> Ai trả
                            cước phí?
                          </label>
                            ...
                            <label
                              ...
                              <div>
                                <strong class="text-success"
                                  >Người gửi trả ngay</strong
                                >
                                <br /><small class="text-muted"
                                  >Thu tiền cước khi nhận hàng</small
                                >
                              </div>
                            </label>
                          </div>
                            ...
                            <label
                              ...
                              <div>
                                <strong class="text-warning"
                                  >Người nhận trả sau</strong
                                >
                                <br /><small class="text-muted"
                                  >Thu khi giao hàng (thêm vào COD)</small
                                >
                              </div>
                            </label>
                          </div>
                          ...
                          <div class="payment-option mb-2">
                            <label
                              ...
                              <div>
                                ...
                                >
                                <br /><small class="text-muted"
                                  >Thu tiền trực tiếp tại quầy</small
                                >
                              </div>
                            </label>
                          </div>
                          <div class="payment-option">
                            <label
                              ...
                              <div>
                                ...
                                >
                                <br /><small class="text-muted"
                                  >Quét QR thanh toán online</small
                                >
                              </div>
                            </label>
                          </div>
                      ...
                      <div
                        ...
                        <strong>Nhắc nhở:</strong> Vui lòng thu
                        <span id="amountToCollect" class="font-weight-bold"
                          >0 ₫</span
                        >
                        từ khách hàng trước khi tạo đơn!
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="fee-summary sticky-top" style="top: 20px">
                    <h5 class="mb-4">
                      <i class="fas fa-calculator"></i> Tổng kết chi phí
                    </h5>
                    ...
                    <div class="mb-3">
                      <small class="opacity-75">
                        ...
                        <span id="chargeableWeightDisplay">0</span> kg
                      </small>
                    </div>
    ...
    <div class="notification-modal-backdrop" id="notificationModal">
      <div class="notification-modal">
        ...
        <div class="notification-modal-footer" id="notificationFooter">
          <button
            class="notification-modal-btn primary"
    ...
    <div class="notification-modal-backdrop" id="confirmModal">
      <div class="notification-modal">
        ...
        <div class="notification-modal-footer">
          <button
            class="notification-modal-btn secondary"
    ...
    <script>
        ...
        if (paymentBy === "sender") {
          ...
          if (paymentMethod === "cash") {
            ...
            $("#paymentReminder").html(
              '<i class="fas fa-money-bill-wave"></i> <strong>Thu tiền mặt:</strong> Vui lòng thu <span class="font-weight-bold">' +
                totalFee +
                "</span> từ khách hàng!"
            );
            ...
            $("#paymentReminder")
              ...
              .show();
            $("#paymentReminder").html(
              '<i class="fas fa-qrcode"></i> <strong>VNPAY:</strong> Sau khi tạo đơn, hệ thống sẽ hiển thị QR Code để khách quét thanh toán.'
            );
          }
        } else {
          $("#paymentReminder").hide();
      ...
      function loadManagerInfo() {
        $.get(
          "${pageContext.request.contextPath}/api/manager/dashboard/stats",
          function (response) {
            if (response.success) {
              currentHubId = response.hubId;
              $("#currentHubInfo").html(
                '<i class="fas fa-building"></i> Hub ID: ' + currentHubId
              );
              loadAvailableRoutes();
            }
          }
          ...
          showNotification(
            "error",
            "Lỗi",
            "Không thể lấy thông tin Hub. Vui lòng đăng nhập lại."
          );
        });
      ...
      function lookupSenderAddresses() {
        ...
        $.get(
          "${pageContext.request.contextPath}/api/manager/inbound/customer-addresses",
          { phone: phone },
          function (addresses) {
            if (addresses && addresses.length > 0) {
              ...
              addresses.forEach(function (addr, index) {
                html +=
                  '<div class="address-suggestion" onclick="selectSenderAddress(' +
                  index +
                  ')" data-index="' +
                  index +
                  '">';
      ...
      function selectSenderAddress(index) {
        ...
        $('.address-suggestion[data-index="' + index + '"]').addClass(
          "selected"
        );
      }
          ...
          function (addresses) {
            if (addresses && addresses.length > 0) {
              ...
              addresses.forEach(function (addr, index) {
                ...
                html +=
                  '<div class="address-suggestion" onclick="selectReceiverAddress(' +
                  index +
                  ')" data-index="' +
                  index +
                  '">';
              ...
              showNotification(
                "info",
                "Thông báo",
                "Không tìm thấy địa chỉ cũ nào cho số điện thoại này."
              );
            }
          }
        );
      ...
      function selectReceiverAddress(index) {
        ...
        $(
          '#receiverAddressList .address-suggestion[data-index="' + index + '"]'
        ).addClass("selected");
      }
      ...
      function loadAvailableRoutes() {
        if (!currentHubId) {
          ...
          $("#routeList").html(
            '<p class="text-warning text-center"><i class="fas fa-exclamation-triangle"></i> Không xác định được Hub hiện tại.</p>'
          );
          return;
        }
        ...
        $.ajax({
          ...
          success: function (routes) {
            ...
            if (routes && routes.success === false) {
              ...
              $("#routeList").html(
                '<p class="text-danger text-center"><i class="fas fa-times-circle"></i> ' +
                  routes.message +
                  "</p>"
              );
              return;
            ...
            if (routes && Array.isArray(routes) && routes.length > 0) {
              ...
              routes.forEach(function (route) {
                const fromHubName = route.fromHub
                  ? route.fromHub.hubName
                  : "N/A";
                const toHubName = route.toHub ? route.toHub.hubName : "N/A";
                const description =
                  route.description ||
                  "Tuyến " + fromHubName + " → " + toHubName;
                const estimatedTime = route.estimatedTime
                  ? " (~" + route.estimatedTime + " phút)"
                  : "";

                html +=
                  '<div class="route-option" onclick="selectRoute(' +
                  route.routeId +
                  ', this)">';
                html +=
              ...
              $("#routeList").html(
                '<p class="text-warning text-center"><i class="fas fa-exclamation-triangle"></i> Không có tuyến đường nào khả dụng từ Hub này.<br><small>Vui lòng liên hệ Admin để thêm tuyến đường.</small></p>'
              );
            }
          },
          error: function (xhr, status, error) {
            ...
            $("#routeList").html(
              '<p class="text-danger text-center"><i class="fas fa-times-circle"></i> Lỗi tải danh sách tuyến đường.<br><small>' +
                error +
                "</small></p>"
            );
          },
      ...
      $("#dropOffForm").on("submit", function (e) {
        ...
        if (!currentManagerId) {
          showNotification(
            "error",
            "Lỗi",
            "Không xác định được Manager. Vui lòng đăng nhập lại."
          );
          return;
        }
        ...
        if (!senderPhone || !receiverPhone) {
          showNotification(
            "warning",
            "Cảnh báo",
            "Vui lòng nhập SĐT người gửi và người nhận!"
          );
          return;
        }
        ...
        if (paymentBy === "sender") {
          ...
          if (paymentMethod === "cash") {
            const totalFee = $("#totalFeeDisplay").text();
            showConfirm(
              "Xác nhận đã thu <strong>" +
                totalFee +
                "</strong> tiền mặt từ khách hàng?",
              function (confirmed) {
                if (confirmed) {
                  submitOrderData(
                    "paid",
      ...
      function submitOrderData(
        ...
        function doSubmit(imagePath) {
          ...
          const apiUrl =
            "${pageContext.request.contextPath}/api/manager/inbound/drop-off" +
            "?senderPhone=" +
            encodeURIComponent(senderPhone) +
            "&receiverPhone=" +
            encodeURIComponent(receiverPhone) +
            "&managerId=" +
            currentManagerId +
            "&routeId=" +
            routeId +
          ...
          $.ajax({
            ...
            success: function (response) {
              if (response.success) {
                ...
                if (paymentBy === "sender" && paymentMethod === "vnpay") {
                  ...
                  const totalFee =
                    parseFloat(totalFeeText.replace(/[^0-9]/g, "")) || 0;
                  ...
                  showConfirm(
                    "<strong>✅ " +
                      response.message +
                      "</strong><br>Mã đơn: <strong>" +
                      requestId +
                      "</strong><br><br>🖨️ Bạn có muốn in tem vận đơn ngay không?",
                    function (confirmed) {
                      if (confirmed) {
            ...
            error: function (xhr) {
              ...
              showNotification(
                "error",
                "Lỗi",
                resp ? resp.message : "Lỗi không xác định"
              );
            },
            complete: function () {
              $('button[type="submit"]')
                .prop("disabled", false)
                .html('<i class="fas fa-check-circle"></i> TẠO ĐƠN HÀNG');
            },
          });
        }
          ...
          $.ajax({
            ...
            beforeSend: function () {
              $('button[type="submit"]')
                .prop("disabled", true)
                .html(
                  '<i class="fas fa-spinner fa-spin"></i> Đang upload ảnh...'
                );
            },
            success: function (response) {
              if (response.success) {
                ...
                showNotification(
                  "error",
                  "Lỗi",
                  "Lỗi upload ảnh: " + response.message
                );
                $('button[type="submit"]')
                  .prop("disabled", false)
                  .html('<i class="fas fa-check-circle"></i> TẠO ĐƠN HÀNG');
            ...
            error: function (xhr) {
              ...
              showNotification(
                "error",
                "Lỗi",
                "Lỗi upload ảnh: " + (resp ? resp.message : "Không xác định")
              );
              $('button[type="submit"]')
                .prop("disabled", false)
                .html('<i class="fas fa-check-circle"></i> TẠO ĐƠN HÀNG');
        ...
        if (files.length > 0) {
          ...
          if (!file.type.startsWith("image/")) {
            showNotification(
              "warning",
              "Cảnh báo",
              "File " + file.name + " không phải là ảnh!"
            );
            return;
          }
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (response.success && response.paymentUrl) {
              ...
              $("#vnpayQrStatus")
                ...
                .addClass("checking")
                .html(
                  '<i class="fas fa-spinner fa-spin"></i><span>Đang chờ khách hàng quét mã...</span>'
                );
          ...
          error: function (xhr) {
            ...
            showNotification(
              "error",
              "Lỗi",
              resp ? resp.message : "Lỗi kết nối VNPAY"
            );
          },
        });
      }
              ...
              if (response.success) {
                ...
                if (status === "success") {
                  ...
                  $("#vnpayQrStatus")
                    ...
                    .addClass("success")
                    .html(
                      '<i class="fas fa-check-circle"></i><span>Thanh toán thành công!</span>'
                    );
        ...
        if (
          ...
          showConfirm(
            "<strong>⚠️ Đã hủy thanh toán VNPAY</strong><br>" +
              "Đơn hàng <strong>#" +
              savedRequestId +
              "</strong> đã được tạo với trạng thái <strong>Chưa thanh toán</strong>.<br><br>" +
