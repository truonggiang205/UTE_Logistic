    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <title>Nhập Kho Từ Xe Tải - Manager Portal</title>
            ...
            <body id="page-top">
                            ...
                            <div class="container-fluid py-4">
                                ...
                                <div class="scan-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h4 class="mb-1"><i class="fas fa-truck-loading"></i> Nhập Kho Từ Xe
                                                Tải (Inter-Hub)</h4>
                                            <p class="mb-0 opacity-75">Quét mã vận đơn khi hàng từ Hub khác
                                                chuyển đến</p>
                                        </div>
                                        <div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="scan-card">
                                            <div class="scan-card-header">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="opacity-75">Hàng đến từ xe tải chuyển
                                                        Hub</small>
                                                </div>
                                            </div>
                                            <div class="scan-card-body">
                                                <form id="hubInboundForm" onsubmit="return processHubInbound(event)">
                                                    <!-- Dropdown chọn loại hành động -->
                                                    <div class="form-group mb-3">
                                                        <label class="font-weight-bold"><i
                                                                class="fas fa-tags text-success"></i> Loại hành
                                                            động</label>
                                                ...
                                                <div id="orderDetail" class="order-detail" style="display: none;">
                                                    ...
                                                    <div class="order-detail-row">
                                                        ...
                                                        <span class="badge badge-success" id="detailStatus">-</span>
                                                    </div>
                                                    <div class="order-detail-row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="stats-box mb-4">
                                            ...
                                            <div>Đơn nhập hôm nay</div>
                                            <small class="opacity-75">Từ xe tải Inter-Hub</small>
                                        </div>

                                        <!-- Lịch sử quét gần đây -->
                                        <div class="scan-card">
                                            <div class="scan-card-header" style="background: #f8f9fc;">
                                                <div class="card-icon" style="background: #11998e; color: #fff;">
                ...
                <script>
                    ...
                    function processHubInbound(event) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/manager/inbound/hub-in',
                            type: 'POST',
                            data: {
                            ...
                            beforeSend: function () {
                                $('#hubInboundForm button').prop('disabled', true)
                            ...
                            complete: function () {
                                $('#hubInboundForm button').prop('disabled', false)
                                    .html('<i class="fas fa-check-circle"></i> XÁC NHẬN NHẬP KHO');
                            }
                        });
                    ...
                    function showOrderDetail(trackingCode, data) {
                        ...
                        $('#detailStatus').text(data.status || 'IN_HUB');
