...
<div class="w-full space-y-8 overflow-x-hidden">
  <div class="flex items-center space-x-3">
    <h1 class="text-2xl font-black text-gray-800 tracking-tight">Tổng quan</h1>
    <div
      ...
      <span
        class="w-2.5 h-2.5 bg-red-500 rounded-full mr-2 animate-pulse"></span>
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-4 mt-2">
        <div
          ...
          <div class="flex items-baseline">
            <span class="text-2xl font-black text-gray-800"
              >${pendingCount}</span
            >
            <span class="text-[10px] font-black text-gray-400 ml-1.5 uppercase"
              >ĐH</span
            >
          </div>
        </div>
        <div class="flex items-center justify-between">
          ...
          >
          <div class="flex items-baseline">
            <span class="text-2xl font-black text-nghv-green">
              <fmt:formatNumber value="${pendingCod}" type="number" /> đ
            </span>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-4 mt-2">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-baseline">
            <span class="text-2xl font-black text-nghv-green">
              <fmt:formatNumber value="${successCod}" type="number" /> đ
            </span>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-4 mt-2">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-baseline">
            <span class="text-2xl font-black text-nghv-green">
              <fmt:formatNumber value="${deliveringCod}" type="number" /> đ
            </span>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-4 mt-2">
        <div class="flex items-center justify-between">
          <span
            class="text-gray-400 font-bold text-xs uppercase tracking-widest"
            >Tổng phí dịch vụ</span
          >
          <div class="flex items-baseline">
            <span class="text-2xl font-black text-gray-800">
              <fmt:formatNumber value="${totalShippingFee}" type="number" /> đ
            </span>
          </div>
        </div>
      </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div
      ...
      <p
        class="text-[11px] font-black text-gray-400 uppercase self-start mb-6 tracking-widest">
        Tỷ lệ đơn hoàn
      </p>
      <div class="chart-container">
        ...
        <div
          ...
          <span class="text-[10px] font-bold text-gray-400 uppercase"
            >Tỷ lệ hoàn</span
          >
          <span class="text-2xl font-black text-gray-800">${returnRate}%</span>
        </div>
      </div>
      <div class="mt-6 flex space-x-6">
        <div
          class="flex items-center text-[10px] font-bold text-gray-500 uppercase">
          <span class="w-3 h-3 bg-[#00B14F] rounded-full mr-2"></span> Giao đi
        </div>
        <div
          class="flex items-center text-[10px] font-bold text-gray-500 uppercase">
          <span class="w-3 h-3 bg-[#F26522] rounded-full mr-2"></span> Bị hoàn
        </div>
      </div>
    </div>
    ...
    <div
      ...
      <p
        class="text-[11px] font-black text-gray-400 uppercase mb-6 tracking-widest">
        Xu hướng hàng - tiền (7 ngày)
      </p>
