...
<html>
  ...
  <body class="bg-slate-50 min-h-screen flex items-center justify-center p-6">
    <div
      class="max-w-md w-full bg-white rounded-[40px] shadow-2xl overflow-hidden border border-orange-50">
      <div
        class="bg-gradient-to-br from-[#F26522] to-[#d44d15] p-10 text-center text-white">
        <div
      ...
      <div class="p-8 text-center space-y-6">
        <p class="text-gray-500 text-sm font-medium leading-relaxed">
          Quá trình thanh toán không thành công. Vui lòng kiểm tra lại số dư tài
          khoản hoặc thay đổi phương thức thanh toán.
        </p>

        <div
          class="bg-orange-50 rounded-2xl p-4 text-[10px] font-black text-orange-600 uppercase tracking-widest">
