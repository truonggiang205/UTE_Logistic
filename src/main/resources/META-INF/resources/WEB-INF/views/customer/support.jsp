  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
    <div>
      ...
      <p class="text-[11px] text-gray-400 font-medium">
        Giải quyết khiếu nại và tra cứu quy định nghiệp vụ
      </p>
    </div>
    <div class="flex bg-gray-100 p-1.5 rounded-[20px]">
      <button
        ...
        id="btn-faq"
        class="px-8 py-2.5 text-[10px] font-black uppercase rounded-2xl transition-all bg-white shadow-sm text-gray-800">
        Quy định NGHV
      </button>
      <button
        onclick="switchTab('ticket')"
        id="btn-ticket"
        class="px-8 py-2.5 text-[10px] font-black uppercase rounded-2xl transition-all text-gray-400">
        Gửi khiếu nại
      </button>
    </div>
  </div>
  ...
  <div id="section-faq" class="space-y-6 animate-fade-in">
    <div
      ...
      <div class="relative z-10">
        <div class="flex items-center space-x-3 mb-6">
          ...
          <h3
            class="text-sm font-black text-gray-800 uppercase tracking-widest">
            Quy định an toàn & Kiểm soát hàng hóa
          </h3>
        </div>

        <p class="text-[11px] text-gray-400 mb-8 italic">
          Căn cứ theo Luật Bưu chính và quy định an ninh vận tải hàng
          không/đường bộ hiện hành.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-2">
              <div
                ...
                <ul class="list-disc pl-4 space-y-2 font-medium">
                  ...
                  <li>
                    Vũ khí đạn dược, trang thiết bị kỹ thuật quân sự (súng, đao,
                    kiếm...).
                  </li>
                  <li>Vật liệu nổ, chất dễ cháy, kíp nổ, pháo hoa.</li>
                  <li>
                    Văn hóa phẩm đồi trụy, tài liệu phản động, phá hoại trật tự
                    công cộng.
                  </li>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-2 text-orange-500">
              ...
              <span class="text-[10px] font-black uppercase tracking-wider"
                >Vận chuyển có điều kiện (Cần khai báo)</span
              >
            </div>
            <div class="space-y-2">
              <div
                ...
                <ul class="list-disc pl-4 space-y-2 font-medium">
                  <li>
                    Chất lỏng, hóa chất (Cần bảng chỉ dẫn an toàn hóa chất
                    MSDS).
                  </li>
                  <li>Hàng điện tử chứa pin, nam châm (Chỉ đi đường bộ).</li>
                  <li>
                    Thực phẩm tươi sống, hàng đông lạnh (Cần đóng gói chuyên
                    dụng).
                  </li>
                  <li>
                    Vàng bạc, đá quý, tiền tệ, các loại giấy tờ có giá trị như
                    tiền.
                  </li>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div class="space-y-1">
              <p class="text-[10px] font-black text-gray-800 uppercase">
                Trách nhiệm người gửi (Shop)
              </p>
              <p class="text-[10px] text-gray-400 font-medium">
                Người gửi chịu hoàn toàn trách nhiệm trước pháp luật nếu cố tình
                gửi hàng cấm. Hệ thống có quyền từ chối phục vụ và bàn giao tang
                vật cho cơ quan chức năng khi phát hiện vi phạm.
              </p>
            </div>
          </div>
        </div>
    ...
    <div
      ...
      <h4 class="text-xs font-black uppercase tracking-widest mb-4">
        Hướng dẫn đóng gói NGHV
      </h4>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="space-y-2">
          <p class="text-[10px] font-black opacity-80 uppercase">Hàng dễ vỡ</p>
          <p class="text-[10px] leading-relaxed">
            Quấn tối thiểu 3 lớp xốp khí, chèn kín các khe hở trong thùng
            carton.
          </p>
        </div>
        <div class="space-y-2">
          <p class="text-[10px] font-black opacity-80 uppercase">
            Hàng chất lỏng
          </p>
          <p class="text-[10px] leading-relaxed">
            Bọc kín miệng bằng nilon, để đứng sản phẩm và có nhãn cảnh báo hướng
            quay lên.
          </p>
        </div>
        <div class="space-y-2">
          ...
          <p class="text-[10px] leading-relaxed">
            Sử dụng màng bọc nilon chống ẩm và chống tĩnh điện trước khi đóng
            hộp.
          </p>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      <div class="lg:col-span-2 space-y-6">
        <div
          ...
          <p
            class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 ml-2">
            Gợi ý khiếu nại nhanh
          </p>
        ...
        <form
          action="/customer/support/ticket/add"
          method="POST"
            ...
            <div class="space-y-2">
              ...
              <select
                ...
                <c:forEach items="${orders}" var="o">
                  <option value="${o.requestId}">
                    #${o.requestId} - ${o.status}
                  </option>
                </c:forEach>
              </select>
            </div>
          ...
          <button
            ...
            <i class="fa-solid fa-paper-plane mr-2"></i> Gửi yêu cầu hỗ trợ ngay
          </button>
        </form>
      </div>
          ...
          <c:forEach items="${myTickets}" var="t">
            <div
              ...
              <div class="flex justify-between items-start mb-3">
                <span
                  class="text-[8px] font-black uppercase px-2 py-1 rounded-lg ${t.status == 'pending' ? 'bg-orange-100 text-orange-600' : t.status == 'processing' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'}">
                  ${t.status}
                </span>
              ...
              <h4
                class="text-xs font-black text-gray-800 uppercase leading-tight group-hover:text-[#00B14F] transition-colors">
                ${t.subject}
              </h4>
              <p
                class="text-[10px] text-gray-400 mt-2 line-clamp-2 italic border-l-2 border-gray-100 pl-3">
                ${t.message}
              </p>
              <div
...
<script>
  function switchTab(tab) {
    ...
    buttons.forEach((b) => {
      document
        .getElementById(b)
        .classList.remove("bg-white", "shadow-sm", "text-gray-800");
  ...
  function applySuggestion(subject, message) {
    ...
    document
      ...
      .classList.add("ring-2", "ring-[#00B14F]");
    setTimeout(() => {
      document
        .getElementById("ticketSubject")
        .classList.remove("ring-2", "ring-[#00B14F]");
    }, 1000);
  }
</script>
