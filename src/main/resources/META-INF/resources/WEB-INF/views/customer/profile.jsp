		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
			<div class="lg:col-span-2 space-y-8">
				<div
					...
					<%-- 
				PHẦN THÔNG TIN NGÂN HÀNG - TẠM ẨN 
				(Cần thêm các field: bankName, bankBranch, accountHolderName, accountNumber vào Customer entity để sử dụng)
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
							<div class="space-y-2">
								<label
									...
									<option value="VCB">VIETCOMBANK - TMCP Ngoại Thương VN</option>
									... (các option khác)
								</select>
							</div>
							<div class="space-y-2">
								<label
									...
									placeholder="Bấm chọn chi nhánh"
									class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl text-xs font-bold focus:ring-2 focus:ring-nghv-green transition-all">
							</div>
							<div class="space-y-2">
								<label
