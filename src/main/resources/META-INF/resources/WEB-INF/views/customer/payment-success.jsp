...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-[40px] shadow-2xl overflow-hidden border border-green-100">
        <div class="bg-[#00B14F] p-10 text-center text-white relative">
            ...
            <h1 class="text-xl font-black uppercase tracking-widest">Thanh toán thành công</h1>
        </div>

        <div class="p-8 space-y-6">
            <div class="text-center">
                <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Số tiền đã quyết toán</p>
                <p class="text-3xl font-black text-gray-800 tracking-tighter">
                    <fmt:formatNumber value="${amount}" type="number" />đ
                </p>
            </div>

            <div class="bg-slate-50 rounded-3xl p-6 space-y-4 border-2 border-dashed border-slate-200">
            ...
            <button onclick="window.location.href='http://localhost:9090/customer/orders'" 
