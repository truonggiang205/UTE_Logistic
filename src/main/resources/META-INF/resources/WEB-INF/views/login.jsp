    ...
    <div class="login-container">
      <div class="login-card">
        ...
        <div class="login-body">
          ...
          <form
            action="${pageContext.request.contextPath}/do-login"
            method="post">
          ...
          <div class="demo-accounts">
            ...
            <button
              type="button"
              class="demo-btn"
              onclick="fillLogin('admin@logistic.local', 'seed:admin123')">
              <div class="role">
            ...
            <button
              type="button"
              class="demo-btn"
              onclick="fillLogin('staff01@logistic.local', 'seed:staff123')">
              <div class="role">
            ...
            <button
              type="button"
              class="demo-btn"
              onclick="fillLogin('shipper01@logistic.local', 'seed:shipper123')">
              <div class="role">
            ...
            <button
              type="button"
              class="demo-btn"
              onclick="fillLogin('cust01@logistic.local', 'cust123')">
              <div class="role">
