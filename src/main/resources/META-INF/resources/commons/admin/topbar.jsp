...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-none d-sm-inline-block">
        <h5 class="m-0 text-dark font-weight-bold">
            <i class="fas fa-cogs mr-2"></i>Admin Portal
        </h5>
    </div>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <h6 class="dropdown-header bg-dark">Thông báo</h6>
...
(function() {
    ...
    var API = ctx + '/api/admin/notifications/recent';
    var pageLink = ctx + '/admin/notifications';
