  ...
  <li class="nav-item">
    ...
    <div id="collapseNetwork" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/hub-management"
          >Quản lý Hub</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/route-management"
          >Tuyến vận chuyển</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    ...
    <div id="collapseFinance" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/service-type-config"
          >Cấu hình Giá cước</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/transactions-reconciliation"
          >Tra soát VNPay</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/cod-management"
          >Đối soát COD</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    ...
    <div id="collapseUsers" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/staff-accounts"
          >Tài khoản nhân viên</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/role-management"
          >Phân quyền Role</a
        >
        <a
          class="collapse-item"
        ...
        <a
          ...
          ><i class="fas fa-users fa-sm text-gray-400"></i> Khách hàng</a
        >
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/vehicle-management">
          <i class="fas fa-truck-moving fa-sm text-gray-400"></i> Quản lý Xe
        </a>
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/driver-management">
        ...
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/trip-monitor">
          <i class="fas fa-route fa-sm text-gray-400"></i> Giám sát Chuyến xe
        </a>
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/container-management">
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/system-monitoring"
          >System Log</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/risk-alerts"
          >Cảnh báo rủi ro</a
        >
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/export-reports"
          >Xuất báo cáo</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        <a
          class="collapse-item"
          href="${pageContext.request.contextPath}/admin/order-status-config"
          >Trạng thái đơn</a
        >
      </div>
    </div>
