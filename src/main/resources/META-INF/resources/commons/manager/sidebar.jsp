...
<ul
  ...
  <a
    ...
    href="<c:url value='/manager/dashboard'/>">
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="<c:url value='/manager/inbound/drop-off'/>"
          >Tạo đơn tại quầy</a
        >
        <a class="collapse-item" href="<c:url value='/manager/inbound/hub-in'/>"
          >Nhập từ xe tải (Hub)</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/inbound/shipper-in'/>"
          >Shipper bàn giao</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="<c:url value='/manager/outbound/consolidate'/>"
          >Đóng bao (Consolidate)</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/outbound/loading'/>"
          >Xếp bao vào xe (Loading)</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/outbound/trip-planning'/>"
          >Điều phối xe (Trip)</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/outbound/gate-out'/>"
          >Xuất bến (Gate Out)</a
        >
        <h6 class="collapse-header">Tra cứu:</h6>
        <a
          class="collapse-item"
          href="<c:url value='/manager/outbound/trip-management'/>"
          >Quản lý Chuyến xe</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="<c:url value='/manager/lastmile/assign-task'/>"
          >Phân công Shipper</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/lastmile/confirm-delivery'/>"
          >Cập nhật kết quả giao</a
        >
        <a
          class="collapse-item"
          href="<c:url value='/manager/lastmile/counter-pickup'/>"
          >Khách nhận tại quầy</a
        >
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="<c:url value='/manager/resource/management'/>"
          >Tài xế &amp; Xe</a
        >
        <a class="collapse-item" href="<c:url value='/manager/shippers'/>"
          >Đội ngũ Shipper</a
        >
      </div>
    </div>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<c:url value='/manager/notifications'/>">
