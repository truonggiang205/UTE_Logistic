    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseDelivery" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseException"
                    aria-expanded="true" aria-controls="collapseException">
                    <i class="fas fa-fw fa-exclamation-triangle"></i>
                    <span>Xử lý Ngoại lệ</span>
                </a>
                <div id="collapseException" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Các đơn lỗi:</h6>
                        <a class="collapse-item" href="<c:url value='/manager/exception/return-init'/>">Kích hoạt Hoàn
                            hàng</a>
                        <a class="collapse-item" href="<c:url value='/manager/exception/return-final'/>">Xác nhận trả
                            Shop</a>
                        <a class="collapse-item" href="<c:url value='/manager/exception/report'/>">Báo cáo Sự cố/Hư
                            hỏng</a>
                    </div>
                </div>
            </li>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                var links = document.querySelectorAll('#accordionSidebar a.collapse-item, #accordionSidebar a.nav-link');
