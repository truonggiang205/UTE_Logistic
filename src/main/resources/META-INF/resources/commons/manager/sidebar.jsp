  ...
  <li class="nav-item">
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a
          class="collapse-item"
          href="<c:url value='/manager/inbound/scan-in'/>"
          >Quét nhập kho</a
        >
        <a
          class="collapse-item"
...
<<<<<<< HEAD
            <li class="nav-item">
                ...
                <div id="collapseOutbound" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tác nghiệp:</h6>
    ...
    <div
      ...
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="<c:url value='/manager/shippers'/>"
          >Đội ngũ Shipper</a
        >
        <a class="collapse-item" href="<c:url value='/manager/drivers'/>"
          >Đội ngũ Tài xế</a
        >
        <a class="collapse-item" href="<c:url value='/manager/vehicles'/>"
          >Phương tiện (Xe tải)</a
        >
      </div>
    </div>
  </li>
