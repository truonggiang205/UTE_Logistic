...
@RestController
@RequestMapping(path = "/api/customer/notifications", produces = MediaType.APPLICATION_JSON_VALUE)
@RequiredArgsConstructor
public class CustomerNotificationRestController {

    private final NotificationService notificationService;

    @GetMapping("/recent")
    public List<NotificationDto> recent() {
        return notificationService.getRecentForRole("CUSTOMER")
                .stream()
