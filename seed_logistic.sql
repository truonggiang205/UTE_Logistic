...
VALUES
  (
    1,
    1, 1, 2, 2,
    DATE_ADD(NOW(), INTERVAL 2 HOUR), 'Handle with care', NULL,
    'pending',
  ...
  (
    2,
    2, 3, 4, 1,
    DATE_ADD(NOW(), INTERVAL 1 HOUR), 'Fragile - glass', NULL,
    'assigned',
  ...
  (
    3,
    3, 5, 6, 2,
    DATE_ADD(NOW(), INTERVAL 30 MINUTE), 'Deliver before 5PM', NULL,
    'in_transit',
  ...
  (
    4,
    4, 7, 8, 1,
    DATE_ADD(NOW(), INTERVAL 3 HOUR), 'Batch order #ACME-0007', NULL,
    'in_transit',
  ...
  (
    5,
    5, 9, 10, 2,
    DATE_ADD(NOW(), INTERVAL 90 MINUTE), 'Keep upright', NULL,
    'delivered',
  ...
  (
    6,
    1, 1, 2, 1,
    DATE_ADD(NOW(), INTERVAL 4 HOUR), 'Customer requests reschedule', NULL,
    'cancelled',
...
VALUES
  ...
  (2, 2, 36000.00, 'SEED-REF-0002', 'TXN-0002', '00', 'Shipping fee payment', 'paid', NOW(), NOW()),
  (3, 5, 48000.00, 'SEED-REF-0005', 'TXN-0005', '00', 'Shipping fee payment', 'paid', DATE_SUB(NOW(), INTERVAL 2 DAY - INTERVAL 4 HOUR), DATE_SUB(NOW(), INTERVAL 2 DAY));
